...
$suffusion_visual_effects_options = array(
	...
	array("name" => "Leading photo maximum dimensions",
		"desc" => "One of your gallery photos is shown enlarged as the default. This is either the featured image or the first image. What maximum size do you want to give it?",
		"id" => "suf_gallery_leading_size",
		"parent" => "post-format-settings",
		"grouping" => "post-format-settings-post-gallery",
		"type" => "radio",
	...
	array("name" => "Leading photo proportional resizing",
	...
	array("name" => "Number of thumbnails to show",
